function chart_Multi_line(chartid,labelname,x_values,y_values,title) {
...
function get_json_render_chart(url, chartid, chart_type, labelname="NoLabelName") {
            $.getJSON(url,function(data) {//请求URL的JSON,得到数据data,下面是对data的处理
                                            ...
                                            else if (chart_type === 'chart_Multi_line')
                                            {
                                                chart_Multi_line(chartid, data.labelname, data.x_values, data.y_values, data.title)
                                            }
                                          });
            }
